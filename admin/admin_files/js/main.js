...
(function () {
  ...
  function Map($canvas, $preview, form) {
    ...
    this.image.onload = function () {
      $canvas.attr({  width: this.width, height: this.height })
        ...
        // load into a container to control size
  ...
  Map.prototype = {
    ...
    select: function (area) {
      $body.addClass('selected'); // selected might not be necessary
      $('#area-remove').show()
      this.selected = area;
  ...
  Rect.SELECTED_FILL = 'rgba(241, 196, 44, 0.7)';
  Rect.DEFAULT_SIZE = 90;
  Rect.ANCHOR_SIZE = 6;
  ...
  $(function () {
    ...
    $canvas
      .on('selectstart', function () { return false; }) //disables everything selection
...
$(document).ready(function() {
  $(".pane-info").on('mousedown', function() {
